export default {
  ...
  'teamInvite.backToSignIn': 'Back to Sign In',
  'teamInvite.description': '{{inviter}} invited you to join the {{appName}} team',
  'teamInvite.descriptionNoInviter': 'You have been invited to join the {{appName}} team',
  'teamInvite.emailHint': 'This invitation was sent to {{email}}',
  'teamInvite.invalid.description':
    'This invitation link is invalid, expired, or has been revoked. Please ask your team admin for a new one.',
  'teamInvite.invalid.title': 'Invitation Not Valid',
  'teamInvite.title': "You're Invited",
